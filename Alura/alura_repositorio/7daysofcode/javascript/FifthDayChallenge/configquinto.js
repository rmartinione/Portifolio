document.addEventListener("DOMContentLoaded", function() {
    ...
    mensagem.textContent = "Bem-vindo ao Quinto Desafio! Neste desafio, você deverá adivinhar uma palavra secreta. Clique em iniciar para começar.";
    ...
    botaoIniciar.addEventListener('click', function() {
        ...
        script.src = 'fifthchallenge.js'; // Chama o arquivo de desafio
